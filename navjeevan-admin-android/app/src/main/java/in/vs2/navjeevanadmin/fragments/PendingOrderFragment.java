...
public class PendingOrderFragment extends Fragment {
	...
	private static final String tag = PendingOrderFragment.class.getSimpleName();
    ...
    static final String SAVED_ORDER = "PendingOrders";
    ...
    private void fillGrid(){
        ...
        if (mOrders != null && mOrders.size() > 0) {
            mAdapter = new OrderAdapter(mOrders,getActivity(),true);
            listView.setAdapter(mAdapter);
        }else{
            Snackbar.make(containerLayout,  "There are no pending orders!", Snackbar.LENGTH_LONG)
                    .show();
        }
    ...
    public class GetOrders extends AsyncTask<String,Integer,JSONObject>{
        ...
        protected JSONObject doInBackground(String... strings) {
            try {
                ...
                return  parser.getJSONFromUrl(Const.GET_PENDING_ORDER, JSONParser.GET,null);
