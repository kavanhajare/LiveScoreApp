...
public class Offer implements Serializable {
   ...
   /* public int getOrderId() {
    ...
    public static ArrayList<Offer> getOfferListFromServer(Context c,String date) {
        JSONParser parser = new JSONParser(c);
        ArrayList<Offer> offerList = new ArrayList<Offer>();
        try {
            String url = Const.GET_OFFER_LIST + "Date="+date;
            ...
            Logcat.e("Offer List", "Error : " + e.toString());
            return offerList;
        }
    }
