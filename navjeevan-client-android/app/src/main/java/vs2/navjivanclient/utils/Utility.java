...
import vs2.navjivanclient.views.BadgeDrawable;
...
public class Utility {
	...
	public  static void androidVersionCheckSample(){
		if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
			// only for ice-cream sandwich and newer versions
		}
	}
	...
	public static void setBadgeCount(Context context, LayerDrawable icon, int count) {
		...
		try{
			...
			Logcat.e("CreateDrawable", "Erro : " + e.toString());
		}
