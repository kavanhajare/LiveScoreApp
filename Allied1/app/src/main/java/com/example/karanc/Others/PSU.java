...
public class PSU extends AppCompatActivity {
    ...
    private void setupviewpager(ViewPager vp) {
        ...
        adapter.addFragment(new DefinitionPSUFragment(),"Definition");
        adapter.addFragment(new StructurePSUFragment(),"Structure");
        adapter.addFragment(new PopularityPSUFragment(),"Popularity");
