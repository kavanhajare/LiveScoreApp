...
import com.example.karanc.Branch_Classes.Coll_with_Ic;
...
public class Ic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        collbtn= (Button) findViewById(R.id.Coll_ic);
        collbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(getApplicationContext(), Coll_with_Ic.class);
