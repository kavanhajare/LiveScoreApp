...
public class TOEFL extends AppCompatActivity {
    ...
    private void setupviewpager(ViewPager vp) {
        ...
        adapter.addFragment(new DefinitionTOEFLFragment(),"Definition");
        adapter.addFragment(new StructureTOEFLFragment(),"Structure");
        adapter.addFragment(new PopularityTOEFLFragment(),"Popularity");
