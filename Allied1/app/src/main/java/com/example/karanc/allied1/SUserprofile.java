...
public class SUserprofile extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_suserprofile);
...
/*        textView = (TextView) findViewById(R.id.susernametv);
        textView.setText("Welcome to Home Screen:  "+ MainSActivity.email);
*/
        baselayout = (RelativeLayout) findViewById(R.id.relativestud);
        //  baselayout.setVisibility(View.VISIBLE);

/*
        TextView welcometv= (TextView) findViewById(R.id.welcometv);
        welcometv.setText("Welcome to Home Screen:  "+ MainSActivity.email);
...
*/
        ...
        Animation anim = AnimationUtils.loadAnimation(SUserprofile.this, R.anim.translate);
        ...
        View header = navigationView.inflateHeaderView(R.layout.nav_header_suserprofile);
...
profnewfabfemale.setOnClickListener(new View.OnClickListener() {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.nav_view_reviews:
                fragment = new ReviewsSnA();
                title = "View Reviews";
                break;
