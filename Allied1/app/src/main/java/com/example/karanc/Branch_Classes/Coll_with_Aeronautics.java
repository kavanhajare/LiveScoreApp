 ...
 */
public class Coll_with_Aeronautics extends Activity{
    InputStream is = null;
    String result = null;
    String line = null;
...
// Load image, decode it to Bitmap and return Bitmap synchronously
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(Coll_with_Aeronautics.this, IndividualCollView.class);
    ...
    private class LoadData extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                HttpPost httppost = new HttpPost("http://192.168.196.101/college/get_college_name_branch_wise.php");
