...
public class IELTS extends AppCompatActivity {
    ...
    private void setupviewpager(ViewPager vp) {
        ...
        adapter.addFragment(new DefinitionIELTSFragment(),"Definition");
        adapter.addFragment(new StructureIELTSFragment(),"Structure");
        adapter.addFragment(new PopularityIELTSFragment(),"Popularity");
