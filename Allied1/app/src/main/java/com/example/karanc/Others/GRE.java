...
private TabLayout tabLayout;
    ...
    private void setupviewpager(ViewPager vp) {
        ...
        adapter.addFragment(new DefinitionFragment(),"Definition");
        adapter.addFragment(new StructureFragment(),"Structure");
        adapter.addFragment(new PopularityFragment(),"Popularity");
